...
extern void save_Result_ToFile(double BW, char* szFilename);
#ifdef TUNED
...
#pragma omp parallel for
    ...
    // Value of the triad result to be saved on file.
    triadBWValue = 1.0E-06 * bytes[3]/mintime[3];
    save_Result_ToFile(triadBWValue, "streamresult.dat");
...
void save_Result_ToFile(double BW, char* szFilename)
{
    FILE* file = fopen (szFilename, "w");
	
    fprintf (file, "%11.4f", BW);
