...
def default(compiler='g++', execute=False, nthreads=1, output=False, compile=True):
...
"""
    ...
    if args.mode == 'default':
        ...
        # generate source code only, no compile
        default(compiler=args.compiler, execute=args.execute,
                nthreads=args.nthreads, output=args.output, compile=False)
